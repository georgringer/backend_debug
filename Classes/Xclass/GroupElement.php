        ...
        if ($internalType === 'file_reference' || $internalType === 'file') {
            foreach ($selectedItems as $selectedItem) {
                ...
                $selectorOptionsHtml[] =
                    ...
                    . htmlspecialchars(FormElementUtility::appendValueToLabelInDebugMode($shortenedTitle, $uidOrPath))
                    . '</option>';
                // Xclass start
            }
            ...
            foreach ($selectedItems as $selectedItem) {
                ...
                $selectorOptionsHtml[] =
                    ...
                    . htmlspecialchars(FormElementUtility::appendValueToLabelInDebugMode($shortenedTitle, $tableWithUid))
                    . '</option>';
                // Xclass start
            }
        } else {
